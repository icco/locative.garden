...
Definition of locative#footnote[locative]

#quote[of, relating to, or being a grammatical case that denotes the place where someone or something is present or the place where an event occurs]

Definition of garden#footnote[garden]

#quote[a plot of ground where herbs, fruits, flowers, or vegetables are cultivated]
...
My name is Nathaniel “Nat” Welch. I also regularly go by icco throughout the internet. I have written two nonfiction books, Real World SRE#footnote[sre] & Reliable Web Servers with Go#footnote[newline]. Today I am writing a collection of short stories to share with you.
...
#footnote[sre] My first book, published by Packt. See https://realworldsre.com.
#footnote[newline] My second book, published by Newline and co-written with Steve Mcarthy. See https://reliableweb.dev.
#footnote[locative] https://www.merriam-webster.com/dictionary/locative retrieved on 2022-01-09
#footnote[garden] https://www.merriam-webster.com/dictionary/garden retrieved on 2022-01-09
